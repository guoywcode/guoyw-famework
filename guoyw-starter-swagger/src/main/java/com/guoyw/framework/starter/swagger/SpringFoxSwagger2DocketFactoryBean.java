...
public class SpringFoxSwagger2DocketFactoryBean implements FactoryBean<Docket>{
  ...
  public SpringFoxSwagger2DocketFactoryBean(String basePackage, String groupName) {
